 ...
 * Exception::Exception()
 *
 *  Purpose:    Create a new exception with a basic error message
 *
 *  Entry:      No entry
 *
 *  Exit:       Created a new exception with a basic error message
 *********************************************************************************************************/
Exception::Exception()
{
 ...
 *
 *  Purpose:    Create a new exception with a given error message
 *
 *  Entry:      Error message of exception
 *
 *  Exit:       Created a new exception with the given error message
 *********************************************************************************************************/
Exception::Exception(char* msg)
    :m_msg(nullptr)
{
 ...
 *
 *  Purpose:    Create a new exception with the same message as an existing exception
 *
 *  Entry:      Exception containing desired error message
 *
 *  Exit:       Created a new exception with the same message as the passed exception
 *********************************************************************************************************/
Exception::Exception(const Exception& copy)
    :m_msg(nullptr)
{
 ...
 * Exception::~Exception()
 *
 *  Purpose:    Safely destroys an exception
 *
 *  Entry:      No entry
 *
 *  Exit:       Frees the memory allocated for the error message
 *********************************************************************************************************/
Exception::~Exception()
{
    delete m_msg;
