...
*		void InOrderHelper(void(*function)(Node<T>*), Node<T> *p)
...
*		void PreOrderHelper(void(*function)(Node<T>*), Node<T> *p)
...
*		void PostOrderHelper(void(*function)(Node<T>*), Node<T> *p)
